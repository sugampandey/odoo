...
companies_docs = {
    'list_companies': doc_generator.create_endpoint_doc(
        'list',
        'company',
        param_schema=COMPANY_LIST_PARAMS,
        response_schema=COMPANY_LIST_RESPONSE
    ),
    'get_company': doc_generator.create_endpoint_doc(
        'get',
        'company',
    ...
    'delete_company': doc_generator.create_endpoint_doc(
        'delete',
        'company',
        param_schema=COMPANY_DELETE_PARAMS
    )
}
